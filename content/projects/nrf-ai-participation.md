...
meetings:
  - date: 2026-06-10
    ...
    decisions:
      - "은현면 8회차 워크숍에 4단계 AI 방법론 적용 — 1~4회차 녹취·인터뷰는 시립대 제공, 8회차 미래상 AI 영상 제공"
      - "단계적 공개 합의 — 1~4회차 데이터 축적 후 5~6회차에 AI 결과 공개·비교"
      - "연계 용역(양주 은현면) 일정에 NRF 협력 반영"
    next:
      - "여주시청 농촌재생과 협의 → 금사면 파일럿 마을 확정"
      - "IRB 신청서 작성·제출 (임계경로)"
      - "취약계층(청년·외국인) 접근 계획 수립"
  - date: 2026-06-10
